...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        return !String.IsNullOrEmpty(We7.CMS.Accounts.Security.CurrentAccountID);
    ...
    public override void SetConfig()
    {
        ...
        //if(Session["ARTICLEDETAIL_CHANNELFILEPATH"] !=null)
        //    BaseUrl = Session["ARTICLEDETAIL_CHANNELFILEPATH"] as string;

        if (Session["WorkPlace"] != null && Session["WorkPlace"].ToString() == "compose")
        {
            BaseUrl = Session["COMPOSE_URL"] as string;
        }
        else if (Session["ARTICLEDETAIL_CHANNELFILEPATH"] != null)
        {
            BaseUrl = Session["ARTICLEDETAIL_CHANNELFILEPATH"] as string;// "/_data/watermark/";
        }
        ...
        // feature.
        if (Session["GENERALCONFIGINFO_CMAXWIDTHOFUPLOADEDIMG"] != null)
            Images.MaxWidth = (int)Session["GENERALCONFIGINFO_CMAXWIDTHOFUPLOADEDIMG"];
        else
            Images.MaxHeight = 0;
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "mpg", "asf", "wma", "wmv", "avi", "mov", "mp3", "rmvb", "mid", "flv" };
        type.DeniedExtensions = new string[] { };
    }
