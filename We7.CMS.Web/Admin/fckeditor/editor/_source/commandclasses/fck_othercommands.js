...
{
    var bt=window.parent.document.getElementById('saveAricleButton');  
    bt.click(); 
    /*
...
//===================We7========================================
var We7CustomCommand = function(commandName )
{
	this.Name = commandName ;
}
We7CustomCommand.prototype =
{
	GetState : function()
	{
        return FCK_TRISTATE_OFF ;
	...
	{
	    var top	= window.top ;
	    top.doCommand(this.Name);
	}
} ;

var We7InsertPlaceHolderCommand = function( )
{
}
We7InsertPlaceHolderCommand.prototype =
{
	GetState : function()
	{
	...
	Execute : function()
	{
//	    var txt='<div contenteditable="false" tag="asp" xmlns:wem="http://www.WestEngine.com" style="border-right: gray 1px dotted; border-top: gray 1px dotted; border-left: gray 1px dotted; width: 100px; border-bottom: gray 1px dotted; height: 50px; background-color: #ff0000">';
//	    txt+='<div tag="asp">内容页位置:MyContentPlaceHolder</div>';
//	    txt+='<div tag="content">';
//	    txt+='<asp:ContentPlaceHolder ID="MyContentPlaceHolder"';
//	    txt+=' runat="server">';
//	    txt+='</asp:ContentPlaceHolder></div></div>';
        var imgstr='<IMG xmlns:wem="http://www.WestEngine.com" tag="wem" class="wem" ';
        var txt = '<asp:ContentPlaceHolder ID="MyContentPlaceHolder" runat="server"> </asp:ContentPlaceHolder> ';
        txt=txt.replace(/&/g, '&amp;').replace(/\"/g, '&quot;').replace(/</g, '&lt;').replace(/>/g, '&gt;');
        var icon="/admin/images/icon_holdplace.png";
        imgstr+=' control="'+txt+'"  src="'+icon+'"  />';
	    FCK.InsertHtml( imgstr ) ;
	}
} ;
//====================================================================
// FCKRuleCommand
