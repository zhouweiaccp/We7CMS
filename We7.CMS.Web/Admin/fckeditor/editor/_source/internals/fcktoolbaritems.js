...
//    		    alert(itemName);
	...
	switch ( itemName )
	{
		...
		case 'CreateDiv'			: oItem = new FCKToolbarButton( 'CreateDiv'	, FCKLang.CreateDiv, null, FCK_TOOLBARITEM_ICONTEXT, false, true, 72 ) ; break ;
        case 'We7_Control' : oItem=new FCKToolbarButton('We7_Control',FCKLang.We7_Control,null,FCK_TOOLBARITEM_ICONTEXT,false,true,6);break;
        case 'We7ControlProp' : oItem=new FCKToolbarButton('We7ControlProp',FCKLang.We7ControlProp,null,FCK_TOOLBARITEM_ICONTEXT,false,true,6);break;
        case 'We7_Subtemplate' : oItem=new FCKToolbarButton('We7_Subtemplate',FCKLang.We7_Subtemplate,null,FCK_TOOLBARITEM_ICONTEXT,false,true,6);break;
        case 'We7_ImportHTML' : oItem=new FCKToolbarButton('We7_ImportHTML',FCKLang.We7_ImportHTML,null,FCK_TOOLBARITEM_ICONTEXT,false,true,6);break;
        case 'We7_CopyTemplate' : oItem=new FCKToolbarButton('We7_CopyTemplate',FCKLang.We7_CopyTemplate,null,FCK_TOOLBARITEM_ICONTEXT,false,true,6);break;
        case 'We7_InsertPlaceHolder' : oItem=new FCKToolbarButton('We7_InsertPlaceHolder',FCKLang.We7_InsertPlaceHolder,null,FCK_TOOLBARITEM_ICONTEXT,false,true,6);break;
        case 'We7_HeadEdit' : oItem=new FCKToolbarButton('We7_HeadEdit',FCKLang.We7_HeadEdit,null,FCK_TOOLBARITEM_ICONTEXT,false,true,6);break;
        case 'We7_SaveTemplate' : oItem=new FCKToolbarButton('We7_SaveTemplate',FCKLang.We7_SaveTemplate,null,FCK_TOOLBARITEM_ICONTEXT,true,null,3);break;
		
		//下面是新控件管理
		case 'We7_Control_New' : oItem=new FCKToolbarButton('We7_Control_New',FCKLang.We7_Control,null,FCK_TOOLBARITEM_ICONTEXT,false,true,6);break;
		case 'We7ControlProp_New' : oItem=new FCKToolbarButton('We7ControlProp_New',FCKLang.We7ControlProp,null,FCK_TOOLBARITEM_ICONTEXT,false,true,6);break;		
