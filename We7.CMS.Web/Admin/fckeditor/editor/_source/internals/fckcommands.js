...
FCKCommands.GetCommand = function( commandName )
{
	...
	switch ( commandName )
	{
        ...
        case 'We7_Control': oCommand=new FCKDialogCommand( 'We7_Control', FCKLang.We7_Control, '/Admin/DataControlListEx.aspx', 700, 500, null, null, true ) ; break ;
//        case 'We7_Control': oCommand=new FCKDialogCommand( 'We7_Control', FCKLang.We7_Control, '/Admin/DataControlList.aspx', 700, 500, null, null, true ) ; break ;
        
        //new FCKDialogCommand('We7_Control',FCKLang.We7_Control,'dialog/workflow/fck_ctrl_date.html',380,230);break;
        case 'We7ControlProp': oCommand=new FCKDialogCommand( 'We7ControlProp', FCKLang.We7ControlProp, 'dialog/we7_addins/we7_control.html', 700, 500, null, null, true ) ; break ;
		
		case 'We7_Subtemplate': oCommand=new FCKDialogCommand( 'We7_Subtemplate', FCKLang.We7_Subtemplate, 'dialog/we7_addins/we7_subtemplate.html', 380, 210, null, null, true ) ; break ;
		
		case 'We7_ImportHTML': oCommand=new We7CustomCommand('importhtml'); break ;
		case 'We7_CopyTemplate': oCommand=new We7CustomCommand('copytemplate'); break ;
		case 'We7_InsertPlaceHolder': oCommand=new We7InsertPlaceHolderCommand(); break ;
		case 'We7_HeadEdit': oCommand=new FCKDialogCommand( 'We7_HeadEdit', FCKLang.We7_HeadEdit, 'dialog/we7_addins/we7_editheader.html', 700, 500, null, null, true ) ; break ;
		case 'We7_SaveTemplate': oCommand = new FCKSaveCommand() ; break ;
		
		//下面是新版控件用的
        case 'We7_Control_New': oCommand=new FCKDialogCommand( 'We7_Control_New', FCKLang.We7_Control, '/Admin/DataControlUI/DataControlListEx.aspx', 700, 500, null, null, true ) ; break ;
		case 'We7ControlProp_New': oCommand=new FCKDialogCommand( 'We7ControlProp_New', FCKLang.We7ControlProp, 'dialog/we7_addins/we7_control_new.html', 700, 500, null, null, true ) ; break ;
