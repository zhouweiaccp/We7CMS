<%@ Page Language="C#" MasterPageFile="~/admin/theme/classic/content.Master" AutoEventWireup="true" CodeBehind="Menulist.aspx.cs" Inherits="We7.CMS.Web.Admin.manage.Menulist" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyContentPlaceHolder" runat="server">
 <script language="javascript" type="text/javascript">
    ...
    <li class="smallButton4">
             <asp:HyperLink ID="AddNewHyperLink" NavigateUrl="AddNewMenu.aspx" runat="server">
          新建菜单
        </asp:HyperLink></li>
        <li class="smallButton8">
        <asp:HyperLink ID="AddMenuHyperLink" NavigateUrl="AddMenu.aspx" runat="server">
            从内容模型新建菜单
        </asp:HyperLink> </li>
        <li class="smallButton8">
      ...
      <WEC:MessagePanel ID="Messages" runat="server">
        ...
        <div style="display:table;width:100%">
         ...
         <p class="search-box" >
	        <label class="hidden" for="user-search-input">搜索菜单:</label>
    ...
    <div>系统菜单可以隐藏和显示，用户自定义菜单可以删除</div>
        ...
        <asp:GridView ID="DataGridView" runat="server" AutoGenerateColumns="False" ShowFooter="True"
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="ID" DataTextField="Title" DataTextFormatString="{0}"
                    DataNavigateUrlFormatString="AddNewMenu.aspx?id={0}" HeaderText="名称" />
                 ...
                 <asp:TemplateField >
                    <ItemTemplate>
                      <a href="<%# Eval("MenuDelUrl") %>" style="display:<%# Eval("MenuDelVisble") %>">删除</a>
                       <a href="<%# Eval("MenuSystemUrl") %>" style="display:<%# Eval("MenuSystemVisble") %>">隐藏</a>
                        <a href="<%# Eval("MenuSystemShowUrl") %>" style="display:<%# Eval("MenuSystemShowVisble") %>">显示</a>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
