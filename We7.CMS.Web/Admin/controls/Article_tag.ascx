<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Article_tag.ascx.cs"
    Inherits="We7.CMS.Web.Admin.controls.Article_tag" %>
<div class="TagsList">
    <div id="conbox">
        <dl>
            <dt>»标签<br />
                ...
                <label class="block_info">
                    标签用于筛选文章到页面不同位置，及用来建立文章关联。下面的系统标签与常用标签点击即可加入为本篇文章的标签。</label>
                <dd>
                    <ul id="tagList">
                ...
                <dd style="clear: both">
                    <input id="tagNameInput" name="tagNameInput" maxlength="20">
                    <br />
