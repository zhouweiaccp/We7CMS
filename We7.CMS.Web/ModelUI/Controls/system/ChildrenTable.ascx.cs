...
{
    public partial class ChildrenTable : We7FieldControl
    {
        ...
        private void InitEditor(DataRow row)
        {
            ...
            rptEditorHeader.DataSource = EditorContext.Panel.EditInfo.Controls;
            rptEditorHeader.DataBind();
        ...
        protected void rptEditorHeader_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            We7Control ctr = e.Item.DataItem as We7Control;
            if (ctr != null)
            {
